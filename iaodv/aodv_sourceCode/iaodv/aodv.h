...
#define LOCATION_PORT		10003
#define AODV_LOCATION_PORT	10004
#define REPLY_LOCATION_PORT	10004    
...
#define HELLO_INTERVAL        1000//1000
...
typedef struct{
	u_int32_t src_ip;
	u_int32_t n_latitude;
	u_int32_t n_longitude;
	u_int32_t dis;
	u_int32_t dst_seq;
}interdata;
...
typedef struct{
	...
	int g_ip_num;
#ifdef REALSIM
	u_int32_t com_radius;
	u_int32_t longitude;
	u_int32_t latitude;
	u_int32_t app_request_id;//add this filed 11.15
#endif
}node_info;
...
struct _dis_record{
	u_int32_t ip;
	u_int32_t dis;
	struct _dis_record *next;
};
typedef struct _dis_record dis_record;
#endif
