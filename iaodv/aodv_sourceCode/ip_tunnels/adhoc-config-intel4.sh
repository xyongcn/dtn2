...
AODV_NET="network_ip=$IP/255.255.0.0"
...
if [ $adhoc0_join -eq 1 ];then
	insmod /system/fbaodv_intel.ko $MESH_DEV $AODV_NET $METRIC $RATE $GATEWAY aodv_blacklist="192.168.1.1,192.168.1.2" dtn_blacklist="192.168.1.1"
fi
